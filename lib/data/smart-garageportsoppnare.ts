...
const SEEDS: ProductSeed[] = [
  ...
  },
  {
    ...
    cons: [
      ...
      "Butiken publicerar ingen specifikation alls, så måtten får du se när lådan är öppnad",
  ...
  },
  {
    ...
    cons: [
      ...
      "Om kontot skyddas av tvåstegsverifiering är okänt",
      "Inget Matter och inget Apple Home",
      "Butiken publicerar varken mått eller märkspänning i klartext",
    ],
    specs: [
...
export const SMART_GARAGEPORTSOPPNARE_CONSIDERED: ConsideredProduct[] = [
  {
    ...
    reason:
      "HomeKit-varianten av den modul vi rankar, 70 kronor dyrare. Den är utelämnad ur rankningen av samma skäl som vi rankar en av två nära identiska varianter i andra kategorier: två poster som bara skiljer sig på en rad hjälper ingen som väljer. Butiken publicerar dessutom ingen strukturerad produktdata, så pris och lagerstatus gick inte att läsa maskinellt. Vill du ha Apple Home är SwitchBot billigare och når dit via Matter, vilket är den lösning som håller längre.",
  },
  {
    brand: "iSmartGate",
