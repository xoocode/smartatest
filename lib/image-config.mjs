...
export function productImage(categorySlug, productId, role = "produkt") {
  return `${IMAGE_ROOT}/${categorySlug}/${productId}-${role}.webp`;
}

export function categoryImage(categorySlug, role = "hero") {
  return `${IMAGE_ROOT}/${categorySlug}/_${role}.webp`;
}
