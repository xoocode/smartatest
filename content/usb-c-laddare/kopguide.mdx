...
Skillnaden mellan laddarna är stor och går att läsa i förväg.
<ProductRef id="ugreen-nexode-pro-65w" /> håller 65 W på första porten och 30 W
på den andra samtidigt. <ProductRef id="linocell-gan-35w" /> tappar 5 W totalt
när den andra enheten sätts i. På <ProductRef id="linocell-premium-gan-140w" />
och <ProductRef id="baseus-gan5-pro-65w" /> är fördelningen okänd, och då får du
räkna med det sämre utfallet.
...
<ProductRef id="unisynk-gan-65w" /> med en på två meter, och
<ProductRef id="ugreen-nexode-100w-utdragbar" /> har sin inbyggd i höljet.
...
är inkopplat. Talet är litet men det är inte noll, och det är ett av få
uppgifter i kategorin som nästan aldrig publiceras.

<ProductRef id="samsung-60w-usb-c" /> anger under 5 milliwatt i vila, vilket
blir några ören om året. För övriga laddare här är siffran okänd. Ekodesignreglerna
för externa nätaggregat sätter tak för tomgångsförbrukning, så nivån ska vara låg
för allt som säljs lagligt inom EU, men vill du veta talet för just din laddare
är det oftast inte tillgängligt.

Praktiskt betyder det att du inte behöver dra ur laddaren av elräkningsskäl.
Drar du ur den ändå är det för att en laddare utan last är en sak mindre som kan
gå sönder.
...
telefonladdare. Står det 65 W ska du ha 65. Står det 140 W finns det två
laddare i den här jämförelsen som klarar det.
...
Ska du bara ha en och slippa tänka: <ProductRef id="ugreen-nexode-pro-65w" />
gör allt ovan utan att du behöver kontrollera något.
